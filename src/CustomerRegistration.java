	...
	public CustomerRegistration() {
		...
		mntmLogOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (JOptionPane.showConfirmDialog(frame, "Are you sure want to log out?", "Product Description", 
		...
		mntmNewMenuItemExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JFrame frame = new JFrame();
				if (JOptionPane.showConfirmDialog(frame, "Are you sure want to exit?", "Product Description", 
						JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
			}
		});
		mnNewMenu.add(mntmNewMenuItemExit);contentPane = new JPanel();
		...
		CustomerInformationtable.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		CustomerInformationtable.getColumnModel().getColumn(0).setPreferredWidth(118);
		CustomerInformationtable.getColumnModel().getColumn(1).setPreferredWidth(160);
		CustomerInformationtable.getColumnModel().getColumn(2).setPreferredWidth(171);
		CustomerInformationtable.getColumnModel().getColumn(3).setPreferredWidth(128);
		scrollPane.setViewportView(CustomerInformationtable);
		...
		UploadButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					for (int i=0; i<CustomerInformationtable.getRowCount(); i++) {
						for (int j=0; j<CustomerInformationtable.getColumnCount(); j++) {
							bw.write(CustomerInformationtable.getModel().getValueAt(i, j) + "  |  ");
							}
		...
		AddressLabel.setFont(new Font("Tahoma", Font.PLAIN, 28));
		...
		NoPhoneLabel.setFont(new Font("Tahoma", Font.PLAIN, 28));
		NoPhoneLabel.setBounds(17, 162, 138, 39);
		panel_2.add(NoPhoneLabel);
		
		JLabel GenderLabel = new JLabel("Gender");
		GenderLabel.setFont(new Font("Tahoma", Font.PLAIN, 28));
		...
		comboBoxGender.setFont(new Font("Tahoma", Font.PLAIN, 28));
		...
		DeleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(CustomerInformationtable.getSelectedRow()==-1) {
					if(CustomerInformationtable.getRowCount()==0) {
					...
					model.removeRow(CustomerInformationtable.getSelectedRow());
				}
			}
		});
		...
		Image photo7 = new ImageIcon(this.getClass().getResource("/Background7.jpg")).getImage();
		...
		PrintButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					CustomerInformationtable.print();
				} catch (Exception e1) {
		...
		UpdateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DefaultTableModel model = (DefaultTableModel)CustomerInformationtable.getModel();
				int i = CustomerInformationtable.getSelectedRow();
