...
public class Login extends JFrame {
	...
	public Login() {
		...
		Image photo1 = new ImageIcon(this.getClass().getResource("/Username.png")).getImage();
		...
		Image photo2 = new ImageIcon(this.getClass().getResource("/Password.png")).getImage();
		...
		Image photo3 = new ImageIcon(this.getClass().getResource("/user-login.png")).getImage();
		...
		Image photo4 = new ImageIcon(this.getClass().getResource("/Background16.jpg")).getImage();
