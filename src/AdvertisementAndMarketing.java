...
public class AdvertisementAndMarketing extends JFrame {
	...
	public AdvertisementAndMarketing() {
		...
		panel.setBounds(182, 269, 672, 314);
		...
		Image photo1 = new ImageIcon(this.getClass().getResource("/loudspeaker.png")).getImage();
