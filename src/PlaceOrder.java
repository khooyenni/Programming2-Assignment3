...
public class PlaceOrder extends JFrame {
	...
	public PlaceOrder() {
		...
		panelTable.setBounds(580, 100, 603, 351);
		...
		scrollPaneOrder.setBounds(11, 17, 577, 259);
		...
		button.setBounds(208, 289, 197, 47);
		panelTable.add(button);
		
		JPanel panel_2 = new JPanel();
		panel_2.setBounds(31, 100, 539, 351);
		...
		comboBoxList.setFont(new Font("Comic Sans MS", Font.BOLD, 12));
		...
		panel_1.setBounds(44, 463, 187, 66);
		...
		AddButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBoxTypeOfDelivery.getSelectedItem().equals("Self Pick Up") ) {
					totalPrice = Double.parseDouble(price) * (Integer) spinnerQuantity.getValue() - ((Double.parseDouble(price) * (Integer) spinnerQuantity.getValue())* 0.10);
				}else {
					totalPrice = Double.parseDouble(price) * (Integer) spinnerQuantity.getValue(); //convert String to double
				}
		...
		panel_8.setBounds(601, 465, 165, 68);
		...
		panel_9.setBounds(770, 465, 165, 68);
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				comboBoxList.setSelectedItem("");
				spinnerQuantity.setValue("");
				comboBoxTypeOfDelivery.setSelectedItem("");
			}
		});
		...
		panel_10.setBounds(939, 465, 165, 68);
		...
		panel_4.setBounds(237, 466, 189, 66);
		...
		panel_7.setBounds(432, 465, 165, 68);
		...
		Image photo7 = new ImageIcon(this.getClass().getResource("/order1.png")).getImage();
		...
		Image photo1 = new ImageIcon(this.getClass().getResource("/Background2.jpg")).getImage();
