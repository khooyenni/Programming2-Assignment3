...
public class AdminHomePage extends JFrame {
	...
	public AdminHomePage() {
		...
		EmployeeManagementButton.setSelectedIcon(new ImageIcon("C:\\Users\\khooy\\Downloads\\employee.png"));
		Image photo1 = new ImageIcon(this.getClass().getResource("/Employee.png")).getImage();
		...
		Image photo3 = new ImageIcon(this.getClass().getResource("/list.png")).getImage();
		...
		Image photo4 = new ImageIcon(this.getClass().getResource("/Money.png")).getImage();
		...
		Image aphoto = new ImageIcon(this.getClass().getResource("/admin.png")).getImage();
		...
		Image photo2 = new ImageIcon(this.getClass().getResource("/Product1.png")).getImage();
		...
		Image photo7 = new ImageIcon(this.getClass().getResource("/Background9.jpg")).getImage();
