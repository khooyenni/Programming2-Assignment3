...
public class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		Image photo7 = new ImageIcon(this.getClass().getResource("/panda.gif")).getImage();
		...
		Image photo = new ImageIcon(this.getClass().getResource("/GroceryBackgroundn.jpg")).getImage();
